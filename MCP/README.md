# Slack AI Plugin MCP Server

This MCP (Model Content Protocol) server provides access to Slack AI Plugin API functionality through HTTP, HTTPS, and STDIO transport modes.
